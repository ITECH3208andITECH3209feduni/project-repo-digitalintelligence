...
<script>
		...
		function httpGetAsync(url, callback) 
		{
			...
			if (xmlHttp.open("GET", url, true)) // true for asynchronous
			{
				document.getElementById("msg2").innerHTML = "";
			}	
			else
			{
				document.getElementById("msg2").innerHTML = "*Enter Valid Email Address";
			}
			
		}
		var eid = document.forms["register"]["email"].value;
		var url = "https://emailvalidation.abstractapi.com/v1/?api_key=823685fcf4374972988167966d9f1e46&email="+eid;
...
<!-- regiater form area start -->
    <div class="contact-form-area pb--120" style= "margin-top:70px;">
        <div class="container">
			...
			<div align="center">
				<button type ="submit" id="neumorphic-button-registerform" name="submit" style=" font-size: 20px; color:#E1E6E1;">Create Account</button>
			</div>
			</form>
		</div>
        </div>
