		...
		<div class="row">
			<div id="loginform" align="center"><br><br><br>
				...
				<form action="logg.php" method="post">
					...
					<button type ="submit" name="submit" id="neumorphic-button-login" style=" font-size: 22px; color:#E1E6E1;">Login</button>
			</div>
				</form>
			<div id="register" align="center"><br><br><br>
				...
				<form>
					<button type ="submit" href="#" id="neumorphic-button-register" style=" font-size: 18px; color:#E1E6E1;">Register with ATMC Credentials</button>
					<br><button href="register.php" type ="submit" id="neumorphic-button-register">Register a New Account</button>
				</form>
			</div>
		</div>
	</div>
