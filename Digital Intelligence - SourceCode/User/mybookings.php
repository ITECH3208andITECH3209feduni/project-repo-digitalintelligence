    ...
    <div class="crumbs-area">
        <div class="container">
            <div class="crumb-content">
                <h4 class="crumb-title">Booking Sessions</h4>
            </div>
        </div>
    </div>
    <!-- crumbs area end -->
		...
		<div class="row">
			...
			<div  class="col-md-10 offset-md-2" >
				<div style="margin-left:80px;">
					...
					$sel="SELECT bookings.*, tutors.name FROM bookings, tutors WHERE tutors.id = bookings.faculty_id and student_id=".$sid.";";
					...
					while($row=mysqli_fetch_array($r))
					{
						...
						?>
						<tr>
						<td><p class="mb-2" style="color: black;">Booking ID: <?php echo $row['booking_id'];?></p></td>
						<td><p class="mb-2" style="color: black;">Time: <?php $row['timeslot'] ?></p></td>
						<td><p class="mb-2" style="color: black;">Date: <?php echo $row['date'];?></p></td>
						<td><p class="mb-2" style="color: black;">Faculty: <?php echo $row['name'];?></p></td>
						<td><?php 
						if($row['meeting_link']!="")
						{
							?>
								<a href="<?php $row['meeting_link']; ?>" class="btn btn-light btn-round">Go To Meeting</a></td>
							<?php 
						}
						?>
						</tr>
