	...
	<div class="row">
		<div id="eventlinks" align="center">
			<form>
				...
				<form>
				<div class="head-bt-left">
					<input type="submit" formaction="news.php" id="event-bt"  value="News">
				</div>
				</form>
				<form>
				<div class="head-bt-left">
        ...
        <div class="events-neumorphic-div-body">
			<div class="row">
				<div id="event1" align="center"><br><br><br>
					<h1 id="event-head1">Event 1</h1><br><br>
					<h4 id="event-head1">Event Details</h4>
				</div>
				<div id="event2" align="center"><br><br><br>
					<h1 id="event-head2">Event 2</h1><br><br>
					<h4 id="event-head2">Event Details</h4>
				</div>
				<div id="event1" align="center"><br><br><br>
					<h1 id="event-head1">Event 3</h1><br><br>
					<h4 id="event-head1">Event Details</h4>
				</div>
			</div>
		</div>
